...
Bar Chart Used for categorical variables like gender. It shows the count (or frequency) of each category.

Histogram Used for continuous variables like age. It groups values into bins and shows the frequency distribution.
